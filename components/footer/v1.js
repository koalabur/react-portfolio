import styles from "/styles/footer/v1.module.scss";
    ...
    return (
        <footer className={styles.footer}>
            <div className={styles.footer__socials}>
                <a
                    href="https://www.linkedin.com/in/cameron-roberts-design/"
                    target="_blank"
                    rel="noreferrer"
                    className={styles["footer__socials-link"]}
                >
                    <svg
                        className={styles["footer__socials-link-icon"]}
                        viewBox="0 0 512 512"
                ...
                <a
                    href="https://github.com/koalabur"
                    target="_blank"
                    rel="noreferrer"
                    className={styles["footer__socials-link"]}
                >
            ...
            <p className={styles.footer__copyright}>
                © {new Date().getFullYear()} Cameron Roberts.
            </p>
        </footer>
    );
}
